...
export const campusHighlights = [
  {
    ...
    description: 'TSG is the hub of all student activities, managing sports, social services, technology clubs, and cultural activities under a single representative body.',
    logoImg: '/Induction-2026/tsg.avif',
  ...
  },
  {
    ...
    description: 'Halls of residence are student living quarters within educational institutions, providing a communal environment with amenities like living spaces, study areas, and recreational facilities. Managed by resident advisors, they foster social connections and academic success, serving as a home away from home for students.',
    logoImg: '/Induction-2026/halls.png',
    bgGradient: 'from-amber-500/10 to-orange-500/10',
    borderColor: 'border-amber-500/20'
  },
  {
    id: 'festivals',
    title: 'Spring Fest, Kshitij & Shaurya',
    description: "Spring Fest one of Asia's largest cultural fest, Kshitij the largest techno-management fest in Asia and the Shourya Sports fest are the flagship annual fests of IIT KGP organized entirely by students.",
    logoImg: '/Induction-2026/fest.jpg',
  ...
  },
  {
    id: 'festivals',
    title: 'Illumination',
    description: "The annual Illumination and Rangoli competition at IIT Kharagpur is a key part of the Diwali celebrations. Organized by the Technology Students' Gymkhana as part of the Inter-hall events, the competition sees halls of residence creating large and intricate designs.",
    logoImg: '/Induction-2026/illu.png',
    bgGradient: 'from-pink-500/10 to-rose-500/10',
    borderColor: 'border-pink-500/20'
  }
];
...
export const clubsData = [
  // Tech
  {
    ...
    category: 'Tech',
    logoImg: '/Induction-2026/koss-logo.jpg',
  },
  {
    ...
    category: 'Tech',
    logoImg: '/Induction-2026/cgs-logo.jpg',
  },
  {
    ...
    category: 'Tech',
    logoImg: '/Induction-2026/kdag-logo.jpg',
  },
  {
    name: 'Kodein KGP',
    ...
    category: 'Tech',
    logoImg: '/Induction-2026/kik-logo.jpg',
  },
  // Cultural
  {
    name: 'Pravah',
    ...
    category: 'Cultural',
    logoImg: '/Induction-2026/pravah-logo.jpg',
  },
  {
    name: 'BreakFree',
    ...
    category: 'Cultural',
    logoImg: '/Induction-2026/bf-logo.jpg',
  },
  {
    name: 'Comedy Club',
    ...
    category: 'Cultural',
    logoImg: '/Induction-2026/comc-logo.jpg',
  },
  {
    ...
    category: 'Cultural',
    logoImg: '/Induction-2026/tls-logo.jpg',
  },
  // Social
  {
    ...
    category: 'Welfare',
    logoImg: '/Induction-2026/swg-logo.jpg',
  },
  {
    ...
    category: 'Welfare',
    logoImg: '/Induction-2026/iwg-logo.jpg',
  },
  {
    ...
    category: 'Welfare',
    logoImg: '/Induction-2026/tes-logo.jpg',
  },
  {
    ...
    category: 'Welfare',
    logoImg: '/Induction-2026/ti-logo.jpg',
  },
  // Sports
  {
    ...
    category: 'Sports',
    logoImg: '/Induction-2026/tads-logo.jpg',
  },
  {
    name: 'Chess Club',
    ...
    category: 'Sports',
    logoImg: '/Induction-2026/chess.jpg',
  },
];
...
export const faqsData = [
  {
    id: 1,
    question: "What is ERP and how do I register or log in?",
    answer: "ERP stands for Enterprise Resource Planning portal. It is the central web interface for your academic curriculum, fee payment, course registration, attendance tracking, and grade sheets. You will receive an official login ID and temporary password after your admission is confirmed. Access it via: https://erp.iitkgp.ac.in/"
  },
  {
    id: 2,
    question: "Is attendance mandatory at IIT KGP?",
    answer: "While a 75% attendance rule has traditionally been standard, recent reforms mean students are no longer deregistered from courses for falling short. However, attendance remains highly recommended as individual professors still have the discretion to factor it into continuous internal evaluation and grading components"
  },
  {
    id: 3,
    question: "What is the grading system at IIT Kharagpur?",
    answer: "IIT KGP uses a 10-point scale for SGPA (Semester Grade Point Average) and CGPA (Cumulative Grade Point Average). Grades ranges from EX (Excellent, 10 points), A (9 points), B (8 points), C (7 points), D (6 points), P (Pass, 5 points), to F (Fail, 0 points)"
  },
  {
    id: 4,
    question: "What is 'Illu' and 'Rangoli' in KGP?",
    answer: "Illumination popularly known as 'Illu' and Rangoli are KGP's most famous and unique inter-hall competitions held during Diwali. Halls build massive bamboo lattices holding thousands of diyas to form breathtaking, intricate designs, alongside massive and detailed rangolis made of vibrant colors"
  },
  {
    id: 5,
    question: "How can I join student clubs and societies?",
    answer: "Selections for clubs, research groups, and societies happen in the first few weeks of the autumn semester (August - September). There are group discussion rounds, interviews, or task-based selections. Keep an eye on Instagram pages, Whatsapp communities and posters inside halls"
  },
  {
    id: 6,
    question: "What is the role of the Technology Students' Gymkhana (TSG)?",
    answer: "TSG is the student governing body of IIT Kharagpur. It manages and organizes all student activities including sports, cultural fests, technological competitions and represents student issues before the institute administration. It is led by the Vice President, GSecs, and student secretaries"
  },
  {
    id: 7,
    question: "How are the sports facilities at IIT KGP?",
    answer: "IIT Kharagpur boasts exceptional sports infrastructure, including an Olympic-sized swimming pool, dedicated grounds for cricket, football, and athletics, and fully equipped indoor complexes for badminton and squash. To promote physical fitness, all first-year students undergo mandatory physical training through programs like the National Sports Organisation (NSO)"
  },
  {
    id: 8,
    question: "What is the scope of extra curricular activities at IIT KGP?",
    answer: "All extra-curricular activities are governed by the Technology Students' Gymkhana across four sections: NSO-National Sports organisation, NCC-National Cadets Corps, NSS-National Service Scheme and HnF-Health and Fitness. All these 4 sectors have graded credits in the first two years and along with these in the beginning of every year GC-General Championship which is an inter hall competition is also organized across all the domains such as ssports, technology and socult"
  },
];
...
export const welcomeData = [
  {
    ...
    role: "Director IIT KGP",
    quote: "It gives me great pleasure to welcome you to the Indian Institute of Technology Kharagpur, a place where knowledge meets purpose, and aspirations find wings. As your journey begins here, remember: greatness is not inherited, it is crafted day by day with discipline and a vision that looks beyond the ordinary. Welcome to the IIT Kharagpur family. May your journey here be filled with growth, friendships, and the quiet confidence that you belong",
  },
  {
    id: 2,
    name: "Prof. Rintu Banerjee",
    role: "Deputy Director IIT KGP",
    quote: "A warm and heartfelt welcome to IIT Kharagpur, your new home, your new beginning. It gives me immense pleasure to welcome each one of you to this extraordinary campus, where dreams are nurtured, ideas take flight, and futures are shaped every single day. You're stepping into a place that has already renowned as an academic institution which has living legacy. Welcome once again. This is your time, make it count, live with purpose, create with passion let innovation shape your journey",
  },
  {
    id: 3,
    name: "Capt. Amit Jain",
